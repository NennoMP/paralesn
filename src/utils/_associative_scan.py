"""Jax-PyTorch porting of associative scan from [1]_.

References
----------
.. [1] https://github.com/i404788/s5-pytorch/blob/
74e2fdae00b915a62c914bf3615c0b8a4279eb84/s5/jax_compat.py#L50-L134
"""

__all__ = ["associative_scan"]
...
def binary_operator(
    ...
    # https://github.com/i404788/s5-pytorch/blob/
    # 74e2fdae00b915a62c914bf3615c0b8a4279eb84/s5/s5_model.py
    """
...
def associative_scan(elems, operator=binary_operator, axis=0, reverse=False):
    """PyTorch impementation of JAX's jax.lax.associative_scan."""
    ...
    if not all(int(elem.shape[axis]) == num_elems for elem in elems_flat[1:]):
        raise ValueError(
            ...
            f"first dimension. (saw: {[elem.shape for elem in elems_flat]})"
        )
    ...
    def _scan(elems):
        ...
        even_elems = [
            ...
            if result.shape.numel() > 0
                ...
                slice_along_axis(0, 1, axis=axis)
...
def _interleave(a, b, axis):
    ...
    if b_trunc:
        ...
        interleaved = interleaved[
            slice_along_axis(0, b.shape[axis] + a.shape[axis] - 1, axis=axis)
        ]
    return interleaved